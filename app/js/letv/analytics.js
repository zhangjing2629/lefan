// 乐视数据统计信息
define('letv/analytics', function(require, exports, module) {
    (function() {
        ...
        function La(a) {
            var b = 1,
                ...
                d;
            if (a)
                for (b = 0, d = a[y] - 1; 0 <= d; d--) c = a.charCodeAt(d),
    ...
    function letvAlysGenCookie() {
        ...
        if (!letvcookie) {
            ...
            letvAlysSetCookie("tj2_lc", letvcookie, {
                exp: "forever"
            });
        }
        return letvcookie;
    ...
    function letvAlysGenSourceUrl() {
        ...
        if (!sourceUrl) {
            if (document.referrer) {
                ...
                letvAlysSetCookie("sourceUrl", sourceUrl, {
                    exp: 0.5
                });
            }
        }
    ...
    function letvAlysGenSessionId() {
        ...
        if (tj_sg == null || tj_sg == "") {
            ...
            letvAlysSetCookie("tj_sid", tj_sid, {
                exp: 0.5
            }); //有效期1hour
        } else {
    ...
    return {
        letvAlysSendAction: letvAlysSendAction,
        letvAlyStart: letvAlyStart
    }
