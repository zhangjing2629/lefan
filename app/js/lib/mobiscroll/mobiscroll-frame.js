define('lib/mobiscroll/mobiscroll-frame', function(require, exports, module) {
    (function($, window, document, undefined) {
        ...
        ms.classes.Frame = function(el, settings, inherit) {
            ...
            that.show = function(prevAnim, prevFocus) {
                ...
                html = '<div lang="' + s.lang + '" class="dw-liq mbsc-' + s.theme + (s.baseTheme ? ' mbsc-' + s.baseTheme : '') + ' dw-' + s.display + ' ' +
                    (s.cssClass || '') +
                    // (that._isLiquid ? ' dw-liq' : ' dw-liq') +
