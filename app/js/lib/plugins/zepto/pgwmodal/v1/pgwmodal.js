/**
 * @fileoverview 模态对话框组件，base on jQuery or Zepto From：https://github.com/Pagawa/PgwModal
 * @authors liyifei@letv.com
 * @date 2015/11
 */

define('lib/plugins/zepto/pgwmodal/v1/pgwmodal', function(require, exports, module) {

    // var $ = require('lib/chaos/zepto');
    ...
    function pgwmodal(obj) {
        ...
        var create = function() {
            ...
            var appendBody = '<div id="pgwModalBackdrop"></div>' + '<div id="pgwModal">' + '<div class="pm-container">' + '<div class="pm-body">' + '<span class="pm-close"></span>' + '<div class="pm-title"></div>' + '<div class="pm-content"></div>' + '</div>' + '</div>' + '</div>';
